...
abstract class PageGenerator(private val name: String, useBaseBloc: Boolean?, templateName: String) {
    ...
    init {
        ...
        try {
            ...
            val resourceAsStream = PageGenerator::class.java.getResourceAsStream(resource)
